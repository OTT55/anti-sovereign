/* OTT Studio — shared front-end helpers (no framework). */
...
// No Content-Type header set on purpose — the browser sets multipart/form-data
// with the right boundary itself; setting it manually breaks file uploads.
...
(function () {
  ...
  function renderResults(list) {
    ...
    if (!host) return;
    if (!list.length) {
      host.innerHTML = '<div class="palette-empty">Type to search workspaces and projects…</div>';
      return;
    }
